...
2. **Central Hub (Serwer gRPC + WebSockets):** Działa jako serwer gRPC nasłuchujący raportów od urządzeń oraz jako serwer WebSockets, który w czasie rzeczywistym wypycha odebrane dane do interfejsu graficznego.
3. **Dashboard Webowy (Klient WebSockets):** Interfejs użytkownika, który dynamicznie reaguje na komunikaty z centrali i aktualizuje statusy urządzeń na żywo.
